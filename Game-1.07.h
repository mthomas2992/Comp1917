...
typedef struct _game * Game; //Corey
...
typedef char path[PATH_LIMIT]; //matt
...
Game newGame (int discipline[], int dice[]); //joerick
...
void makeAction (Game g, action a); //Corey

// advance the game to the next turn,
// assuming that the dice has just been rolled and produced diceScore
// the game starts in turn -1 (we call this state "Terra Nullis") and
// moves to turn 0 as soon as the first dice is thrown.
void throwDice (Game g, int diceScore); //matt
...
// 2..12
int getDiceValue (Game g, int regionID); //joerick

// which university currently has the prestige award for the most ARCs?
// this is NO_ONE until the first arc is purchased after the game
// has started.
int getMostARCs (Game g); //Bryan

// which university currently has the prestige award for the most pubs?
// this is NO_ONE until the first publication is made.
int getMostPublications (Game g); //Corey
// return the current turn number of the game -1,0,1, ..
int getTurnNumber (Game g); //matt

// return the player id of the player whose turn it is
// the result of this function is NO_ONE during Terra Nullis
int getWhoseTurn (Game g); //charly
...
int getARC(Game g, path pathToEdge); //Bryan
...
int isLegalAction (Game g, action a); //Corey

// --- get data about a specified player ---

// return the number of KPI points the specified player currently has
int getKPIpoints (Game g, int player); //matt

// return the number of ARC grants the specified player currently has
int getARCs (Game g, int player); //charly

// return the number of GO8 campuses the specified player currently has
int getGO8s (Game g, int player); //joerick

// return the number of normal Campuses the specified player currently has
int getCampuses (Game g, int player); //Bryan

// return the number of IP Patents the specified player currently has
int getIPs (Game g, int player); //Corey

// return the number of Publications the specified player currently has
int getPublications (Game g, int player); //matt

// return the number of students of the specified discipline type
// the specified player currently has
int getStudents (Game g, int player, int discipline); //charly
...
int getExchangeRate (Game g, int player,
                     int disciplineFrom, int disciplineTo); //joerick
